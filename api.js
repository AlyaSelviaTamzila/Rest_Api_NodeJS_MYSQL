...
//TUGAS PRAKTIKUM BIKIN PELANGGARAN MD5
...
app.put("/pelanggaran/:id", (req,res) => {
...
app.get("/pelanggaran_siswa/:id_pelanggaran_siswa", (req,res) => {
    ...
    "from detail_pelanggaran_siswa dps join pelanggaran p on p.id_pelanggaran = dps.id_pelanggaran " +
    "where ?"
